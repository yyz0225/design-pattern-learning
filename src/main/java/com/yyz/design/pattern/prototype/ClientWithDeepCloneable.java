...
public class ClientWithDeepCloneable {
    ...
    public static void main(String[] args) throws Exception{
       ...
       deepCloneProtoType.deepCloneableTarget = new DeepCloneableTarget("克隆名称","克隆类");
        ...
        System.out.println(deepCloneProtoType.deepCloneableTarget.hashCode());
       ...
       // 深拷贝之实现Cloneable接口,重写Object类的clone方法,并逐一拷贝引用的类
        ...
        System.out.println(deepCloneProtoType1.deepCloneableTarget.hashCode());
        ...
        System.out.println(deepCloneProtoType2.deepCloneableTarget.hashCode());
